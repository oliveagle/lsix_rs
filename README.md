...
这是一个用 Rust 重写的高性能版本 [lsix](https://github.com/hackerb9/lsix)，用于在支持 SIXEL 的终端中显示图像缩略图。
...
详见 [PERFORMANCE.md](PERFORMANCE.md) 获取详细的性能分析和优化说明。
...
- 原始的 lsix 由 [hackerb9](https://github.com/hackerb9) 开发
- 本项目使用 Rust 生态系统中的优秀库：
  - [rayon](https://github.com/rayon-rs/rayon) - 数据并行性
  - [clap](https://github.com/clap-rs/clap) - 命令行参数解析
  - [anyhow](https://github.com/dtolnay/anyhow) - 错误处理
  - [regex](https://github.com/rust-lang/regex) - 正则表达式
  - [glob](https://github.com/rust-lang-nursery/glob) - 文件模式匹配
